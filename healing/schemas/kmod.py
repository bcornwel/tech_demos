"""
This file contains the schematic for the kmod_result.log file
"""
    ...
    "additionalProperties": {
        ...
        "properties": {
            ...
            "KERNEL_MOD": {
                ...
                "error message": f"This data should contain a string that matches the format {RegexStrings.Variable}"
            },
            "RESULT": {
                "type": "string",
