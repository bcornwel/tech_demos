"""
This file contains the schematic for the load_result.log file
"""
    ...
    "additionalProperties": {
        ...
        "properties": {
            ...
            "AVG_LOAD": {
                ...
                "error message": f"This data should contain a string that matches the format [0-9]{1,2}.[0-9]{1,2}"
            },
            "RESULT": {
                "type": "string",
